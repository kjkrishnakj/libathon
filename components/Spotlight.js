...
//   return (
//     <div className="bg-yellow-200  p-4 rounded-md shadow-md my-4" style={{height:"44vh"}}>
//       <h2 className="underline text-lg font-bold my-2 text-center text-yellow-900">Spotlight Messages</h2>
//       <ul className="list-disc pl-5">
//         {messages.map((msg) => (
//           <li key={msg._id} className="text-yellow-800">
//             {msg.message}
//           </li>
//         ))}
//       </ul>
...
const Spotlight = () => {
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      try {
        const response = await axios.get("/api/spotlight"); // Axios GET request
  ...
  return (
    <div className="bg-yellow-200 p-4 rounded-md shadow-md my-4" style={{ height: "44vh" }}>
      <h2 className="underline text-lg font-bold my-2 text-center text-yellow-900">
        Spotlight Messages
      </h2>
      <ul className="list-disc pl-5">
        {messages.map((msg) => (
